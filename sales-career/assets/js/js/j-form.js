$(document).ready(function () {
    ...
    $("#j-forms").validate({
        ...
        //    'upload': { required: "Please upload your RESUME"},
        //    'upload': { extends: "Accepts PDF only"},
        ...
        //     'Mob-No-with-country-code': { required: "Mobile is required" },
        ...
        errorPlacement: function (e, s) {
            $(s).is(":checkbox") || $(s).is(":file")|| $(s).is(":radio") ? $(s).closest(".check").append(e) : $(s).closest(".unit").append(e);
        },
   
        submitHandler: function () {
            // var vidFile = document.getElementById("file-upload").files.length;
