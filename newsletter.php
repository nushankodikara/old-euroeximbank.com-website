 ...
 <!-- ##### Breadcrumb Area Start ##### -->
    ...
    <div class="container">
        <div class="credit-tabs-content padding-top-50">
            ...
            <li class="nav-item">
                    <a class="nav-link active show" id="tab--5" data-toggle="tab" href="#tab5" role="tab" aria-controls="tab5"
            ...
            <div class="tab-pane fade active show" id="tab5" role="tabpanel" aria-labelledby="tab--5" >
                    <div class="credit-tab-content ">
                        ...
                        <div class="credit-tab-text">
                            <div class="row">
                             ...
                             <div class="col-md-4">
                                    <div class="card">
                                        <img src="img/media/newsletter/The Trailblazer -  2022.jpg" class="img-fluid img-thumbnail" alt="Trade finance company">
                                        <h5 class="text-center">The Trailblazer H1<br> 2022</h5>
                                        <p class="text-center"><a href="img/media/newsletter_pdf/2022/The Trailblazer - Jan - Jul 2022  Issue 18.pdf" target="_blank"
                    ...
                    <div class="credit-tab-content ">
                        ...
                        <div class="credit-tab-text">
                            <div class="row">
                             ...
                             <div class="col-md-4">
                                    <div class="card">
                                        <img src="img/media/newsletter/The Trailblazer - H2 2021  Issue 16.png" class="img-fluid img-thumbnail" alt="Trade finance company">
                                        <h5 class="text-center">The Trailblazer H2<br> 2021</h5>
                                        <p class="text-center"><a href="img/media/newsletter_pdf/2021/The Trailblazer - H2 2021  Issue 16.pdf" target="_blank"
                                                class="btn btn-dark">View</a></p>
                                    </div>
                                    <!--end card -->
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <img src="img/media/newsletter/the-trailblazer-h1-2021-issue-15.jpg" class="img-fluid img-thumbnail" alt="Trade finance company">
                                        <h5 class="text-center">The Trailblazer H1<br> 2021</h5>
                                        <p class="text-center"><a href="img/media/newsletter_pdf/2021/The-Trailblazer-H1-2021-Issue-15.pdf" target="_blank"
                                                class="btn btn-dark">View</a></p>
                                    </div>
                                    <!--end card -->
                                </div>
                    ...
                    <div class="credit-tab-content ">
                        ...
                        <div class="credit-tab-text">
                            <div class="row">
                             ...
                             <div class="col-md-4">
                                   <div class="card">
                                        <img src="img/media/newsletter/oct-2020-vol1.png" class="img-fluid img-thumbnail" alt="Trade finance company">
                                        <h5 class="text-center">The Trailblazer Vol 1<br> OCT - 2020</h5>
                                        <p class="text-center"><a href="img/media/newsletter_pdf/2020/eeb-weekly-newsletter-vol1-0ct-2020.pdf" target="_blank"
                                                class="btn btn-dark">View</a></p>
                                    </div>
                                    <!--end card -->
                            </div>
                             <div class="col-md-4">
                                    <div class="card">
                                        <img src="img/media/newsletter/2ndweek-newsletter-vol-2.png" class="img-fluid img-thumbnail" alt="Trade finance company">
                                        <h5 class="text-center">The Trailblazer Vol 2<br> OCT - 2020</h5>
                                        <p class="text-center"><a href="img/media/newsletter_pdf/2020/2ndweek-newsletter-vol-2.pdf" target="_blank"
                                                class="btn btn-dark">View</a></p>
                                    </div>
                                    <!--end card -->
                            </div>
